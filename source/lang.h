...
typedef enum {
    LANG_EN,    // English (broken/funny)
    LANG_RU,    // Russian (gopnik)
    LANG_MINECRAFT, // Minecraft Enchanting Table
} Lang;
...
typedef enum {
    ...
    STR_PLUS18_W2_B,
    STR_PLUS18_W2_A,
    STR_PLUS18_KONAMI_TITLE,
    STR_PLUS18_KONAMI_DESC,
    STR_PLUS18_KONAMI_KEYS,
    STR_PLUS18_KONAMI_B,
    STR_PLUS18_K_UP,
    STR_PLUS18_K_DOWN,
    STR_PLUS18_K_LEFT,
