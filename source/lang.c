...
static const char *s_strings[STR_COUNT][2] = {
    ...
    // --- Help lines ---
    [STR_HELP_MODE]          = { "A: Do the thing       L: Music       B: Escape",
                                 "А: Жмяк       L: Музыка       B: Свалить" },
    [STR_HELP_S2]            = { "A: Order Pizza       L: Music       B: Escape",
                                 "А: Взять пиццу       L: Музыка       B: Назад" },
    ...
    // --- +18 & Rickroll screens ---
    [STR_PLUS18_BTN]         = { "+18", "+18" },
    [STR_PLUS18_HELP]        = { "A: Enter (+18)       L: Music       B: Escape",
                                 "А: Залезть (+18)       L: Музыка       B: Свалить" },
    [STR_PLUS18_DESC]        = { "Strictly forbidden content for minors (+18)...",
                                 "Строго запрещено для мелких дебилов (+18)..." },
    [STR_PLUS18_W1_TITLE]    = { "STRICT WARNING (+18)", "АТАС: СТРОГО 18+" },
    [STR_PLUS18_W1_LINE1]    = { "This content is ULTRA DANGEROUS and forbidden for minors!",
                                 "Этот контент ОПАСЕН ДЛЯ ЖИЗНИ и запрещен школьникам!" },
    [STR_PLUS18_W1_LINE2]    = { "Seriously not good at all... adults only!",
                                 "Вообще не тема... строго для старых дедов!" },
    [STR_PLUS18_W1_LINE3]    = { "Are you 100% sure you want to continue?",
                                 "Ты реально на 100% уверен, что лезешь сюда?" },
    [STR_PLUS18_W1_B]        = { "B: Go Back", "B: Свалить отсюда" },
    [STR_PLUS18_W1_A]        = { "A: Continue", "А: Погнали дальше" },
    [STR_PLUS18_W2_TITLE]    = { "FINAL WARNING!", "ПОСЛЕДНЕЕ ПРЕДУПРЕЖДЕНИЕ!" },
    [STR_PLUS18_W2_LINE1]    = { "This is REALLY NOT A TROLL!", "Это ВООБЩЕ НЕ ТРОЛЛИНГ!" },
    [STR_PLUS18_W2_LINE2]    = { "Last chance to turn back before it is too late.",
                                 "Последний шанс свалить, пока не поздно." },
    [STR_PLUS18_W2_LINE3]    = { "Are you absolutely certain?", "Ты точно не передумал?" },
    [STR_PLUS18_W2_B]        = { "B: Continue", "B: Продолжить" },
    [STR_PLUS18_W2_A]        = { "A: Go Back", "А: Назад!" },
    [STR_PLUS18_KONAMI_TITLE] = { "SECRET COMBINATION", "СЕКРЕТНЫЙ ШИФР" },
    [STR_PLUS18_KONAMI_DESC]  = { "To enter the secret menu, input the combination:",
                                 "Чтобы пролезть дальше, введи шифр:" },
    [STR_PLUS18_KONAMI_KEYS]  = { "UP  UP  DOWN  DOWN  LEFT  RIGHT",
                                 "ВВЕРХ  ВВЕРХ  ВНИЗ  ВНИЗ  ВЛЕВО  ВПРАВО" },
    [STR_PLUS18_KONAMI_B]     = { "B: Cancel and return", "B: Отмена и назад" },
    [STR_PLUS18_K_UP]        = { "UP", "ВВЕРХ" },
    [STR_PLUS18_K_DOWN]      = { "DOWN", "ВНИЗ" },
    [STR_PLUS18_K_LEFT]      = { "LEFT", "ВЛЕВО" },
    [STR_PLUS18_K_RIGHT]     = { "RIGHT", "ВПРАВО" },
    [STR_RICKROLL_TITLE]     = { "★ NEVER GONNA GIVE YOU UP ★", "★ НИКОГДА TEBYA NE BROSHU ★" },
    [STR_RICKROLL_SUB]       = { "Press B or + to quit", "Жми B или + чтобы свалить" },
};
